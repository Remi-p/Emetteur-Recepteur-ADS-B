function [ display_plot ]=vekplot2(x,y,u,v,scale,linetype,mark,fillcolour)
...
rel_head=0.6; % length of arrow head relative to total length
% *****
...
if nargin==8 & ~isempty(fillcolour)
   hold on
  display_plot =plot(x,y,mark);
   set(display_plot,'markerFaceColor',fillcolour)
end
